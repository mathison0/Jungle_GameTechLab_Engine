...
IMGUI_API void SceneView(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool borders = true, float rounding = 0.0f);
IMGUI_API void SceneViewBorder(ImVec2 p_min, ImVec2 p_max, float rounding = 0.0f);
