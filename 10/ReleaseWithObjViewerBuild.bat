...
msbuild "%SOLUTION_DIR%CrashEngine.sln" /p:Configuration=ObjViewDebug /p:Platform=x64 /m /v:minimal
if %ERRORLEVEL% neq 0 (
...
copy "%BUILD_OUTPUT_OBJVIEW%\CrashEngine.exe" "%RELEASE_DIR%\ObjViewer.exe" >nul
