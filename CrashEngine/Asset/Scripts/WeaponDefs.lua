...
WeaponDefs.VehicleRush = {
    ...
    Levels = {
        [1] = {
            ...
            MinPassOffset = 8.0,
            MaxPassOffset = 18.0,
            CameraShakeAsset = "VehicleRush",
            CameraShakeScale = 0.24,
            CameraShakeInterval = 0.28,
            Sound = {
                Spawn = "car_beep",
                Bus = "SFX",
                Volume = 1.0,
        ...
        [3] = {
            ...
            MinPassOffset = 9.0,
            MaxPassOffset = 22.0,
            CameraShakeAsset = "TrainRush",
            CameraShakeScale = 0.32,
            CameraShakeInterval = 0.62,
            Sound = {
                Spawn = "thomas",
                Bus = "SFX",
                Volume = 1.5,
