...
void ULightComponent::GetEditableProperties(TArray<FPropertyDescriptor>& OutProps)
{
	...
	OutProps.push_back({ "Shadow Slope Bias",       EPropertyType::Float, &ShadowSlopeBias,       -0.2f, 0.2f, 0.001f });
	OutProps.push_back({ "Shadow Normal Bias",      EPropertyType::Float, &ShadowNormalBias,      -0.2f, 0.2f, 0.001f });
