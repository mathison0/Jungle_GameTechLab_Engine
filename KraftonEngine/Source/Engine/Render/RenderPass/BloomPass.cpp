...
void FBloomPass::Execute(const FPassContext& Ctx)
{
	...
	const float InvWidth = Frame.ViewportWidth > 0.0f ? 1.0f / Frame.ViewportWidth : 0.0f;
	const float InvHeight = Frame.ViewportHeight > 0.0f ? 1.0f / Frame.ViewportHeight : 0.0f;
