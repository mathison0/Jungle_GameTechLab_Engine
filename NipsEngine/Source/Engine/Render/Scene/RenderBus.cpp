...
const TArray<FRenderCommand>& FRenderBus::GetCommands(ERenderPass Pass) const { return PassQueues[(uint32)Pass]; }
...
void FRenderBus::SetFogConstants(const FFogConstants& InFog) { FogConstants = InFog; }

void FRenderBus::SetLightingConstants(const FLightingConstants& InLighting) { LightingConstants = InLighting; }
