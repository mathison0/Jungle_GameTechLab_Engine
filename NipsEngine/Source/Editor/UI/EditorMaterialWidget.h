...
private:
    void RenderSectionList(UStaticMeshComponent* MeshComp, UDecalComponent* DecalComp);
    void RenderMaterialDetails(UStaticMeshComponent* MeshComp, UDecalComponent* DecalComp);

    void RenderColorSection(FMaterial& Mat);
    void RenderScalarSection(FMaterial& Mat);
    void RenderTextureSection(FMaterial& Mat);

    USceneComponent* GetSelectedTargetComponent() const;
...
private:
    ...
    UDecalComponent*      LastDecalComp = nullptr;
};
