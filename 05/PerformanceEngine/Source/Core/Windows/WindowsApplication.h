...
public:
	...
	FWindowsWindow* MakeWindow(const WCHAR* Title, int Width, int Height, int X = 100, int Y = 100) const;
	...
	void AddMessageFilter(FWndProcFilter Filter) const;
	void SetOnResizeCallback(FOnResizeCallback Callback) const;
