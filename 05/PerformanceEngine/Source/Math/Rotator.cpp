...
{
	return FRotator(InEulerDegrees.X, InEulerDegrees.Y, InEulerDegrees.Z);
}
...
FRotator FRotator::Add(float DeltaXDegrees, float DeltaYDegrees, float DeltaZDegrees) noexcept
{
	Roll += DeltaXDegrees;
	Pitch += DeltaYDegrees;
	Yaw += DeltaZDegrees;
